        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              <h2 className="text-3xl md:text-4xl font-bold text-text">The Story Behind URAAN</h2>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-4">
                <img src="https://images.pexels.com/photos/3184292/pexels-photo-3184292.jpeg" alt="Pakistani women entrepreneurs" className="w-full h-48 object-cover rounded-2xl" />
                <img src="https://images.pexels.com/photos/3769021/pexels-photo-3769021.jpeg" alt="Women working together" className="w-full h-32 object-cover rounded-2xl" />
              </div>

              <div className="space-y-4 pt-8">
                <img src="https://images.pexels.com/photos/3184639/pexels-photo-3184639.jpeg" alt="Woman with laptop" className="w-full h-32 object-cover rounded-2xl" />
                <img src="https://images.pexels.com/photos/3184338/pexels-photo-3184338.jpeg" alt="Successful entrepreneur" className="w-full h-48 object-cover rounded-2xl" />
              </div>
            </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-baby-powder to-base">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="relative">
            <div className="absolute left-1/2 transform -translate-x-px h-full w-0.5 bg-gradient-to-b from-primary to-accent2" />
            ...
            <div className="space-y-12">
              {timeline.map((item, index) => (
                <div key={index} className={`flex items-center ${index % 2 === 0 ? 'flex-row' : 'flex-row-reverse'}`}>
                  ...
                  <div className="w-4 h-4 bg-primary rounded-full border-4 border-baby-powder relative z-10" />
                  <div className="w-1/2" />
