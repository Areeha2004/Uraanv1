...
import { X, Calendar, DollarSign, FileText, User, Clock, CheckCircle } from 'lucide-react';
...
const HireCollaboratorModal: React.FC<HireCollaboratorModalProps> = ({ collaborator, onClose }) => {
    ...
    <div className="fixed inset-0 bg-[#afa3c9]/50 backdrop-blur-md flex items-center justify-center z-50 p-4">
      <div className="bg-glass-bg backdrop-blur-lg border border-secondary/20 rounded-3xl max-w-2xl w-full max-h-[90vh] overflow-y-auto shadow-2xl">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          {/* Project Title */}
          <div>
            <label htmlFor="projectTitle" className="block text-sm font-medium text-[#190357] mb-2">
              Project Title *
            </label>
            <div className="relative">
              <FileText className="absolute left-3 top-1/2 transform -translate-y-1/2 text-[#190357]" size={18} />
              <input
                id="projectTitle"
                name="projectTitle"
                type="text"
            ...
            {errors.projectTitle && (
              <p className="mt-2 text-sm text-red-600">{errors.projectTitle}</p>
            )}
          </div>

          {/* Project Description */}
          <div>
            <label htmlFor="projectDescription" className="block text-sm font-medium text-[#190357] mb-2">
              Project Description *
            </label>
            <textarea
            ...
            />
            {errors.projectDescription && (
              <p className="mt-2 text-sm text-red-600">{errors.projectDescription}</p>
            )}
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <label htmlFor="budget" className="block text-sm font-medium text-[#190357] mb-2">
                Budget Range *
              </label>
              <div className="relative">
                <DollarSign className="absolute left-3 top-1/2 transform -translate-y-1/2 text-[#190357]" size={18} />
                <select
                  id="budget"
                  name="budget"
            ...
            <div>
              <label htmlFor="timeline" className="block text-sm font-medium text-[#190357] mb-2">
                Timeline *
              </label>
              <div className="relative">
                <Clock className="absolute left-3 top-1/2 transform -translate-y-1/2 text-[#190357]" size={18} />
                <select
                  id="timeline"
                  name="timeline"
          ...
          {/* Contact Method */}
          <div>
            <label htmlFor="contactMethod" className="block text-sm font-medium text-[#190357] mb-2">
              Preferred Contact Method
            </label>
            <div className="relative">
              <User className="absolute left-3 top-1/2 transform -translate-y-1/2 text-[#190357]" size={18} />
              <select
                id="contactMethod"
                name="contactMethod"
          ...
          {/* Additional Info */}
          <div>
            <label htmlFor="additionalInfo" className="block text-sm font-medium text-[#190357] mb-2">
